const CACHE = "zroute-planner-v7";
const ASSETS = ["./", "./index.html", "./i18n.js", "./assets/buildings/research.svg", "./assets/buildings/drill.svg", "./assets/buildings/soldier.svg", "./assets/buildings/military.svg", "./assets/buildings/defense.svg", "./assets/buildings/medical.svg", "./assets/buildings/economy.svg", "./assets/buildings/default.svg", "./manifest.webmanifest", "./icon.svg", "./data/progression.json", "./data/resources.json"];
