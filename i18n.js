(function (global) {
  ...
  const ROWS = [
    ...
    ["Planner inputs", "Entrées du planificateur", "Параметры планировщика", "Planlayıcı girdileri", "Dane wejściowe planera", "Entradas del planificador", "Dados de entrada do planeador", "Planereingaben", "플래ナー 입력", "プランナー入力", "规划器输入"],
    ...
    ["Import JSON", "Importer le JSON", "Импортировать JSON", "JSON içe aktar", "Importuj JSON", "Importar JSON", "Importar JSON", "JSON importieren", "JSON 가져오기", "JSON을 인ポート", "导入 JSON"],
    ...
    ["Total resources", "Ressources totales", "Общие ресурсы", "Toplam kaynaklar", "Łąчные ресурсы", "Recursos totales", "Recursos totais", "Gesamte Ressourcen", "총 자원", "合計リソース", "总资源"],
    ...
    ["Radar", "Radar", "Радар", "Radar", "Radar", "Radar", "Radar", "Radar", "레이ダー", "レーダー", "雷达"],
    ...
    // Promo Codes UI Localizations
    ["Z Route Codes", "Codes Z Route", "Коды Z Route", "Z Route Kodları", "Kody Z Route", "Códigos de Z Route", "Códigos Z Route", "Z-Route-Codes", "Z Route 코드", "Z Routeコード", "Z Route 兑换码"],
    ["Search codes...", "Rechercher des codes...", "Поиск кодов...", "Kodlarda ara...", "Szukaj kodów...", "Buscar códigos...", "Pesquisar códigos...", "Codes suchen...", "코드 검색...", "コードを検索...", "搜索兑换码..."],
    ["All", "Tous", "Все", "Tümü", "Wszystkie", "Todos", "Todos", "Alle", "전체", "すべて", "全部"],
    ["Unused", "Non utilisés", "Неиспользованные", "Kullanılmamış", "Nieużywane", "Sin usar", "Não usados", "Ungenutzt", "미사용", "未使用", "未使用"],
    ["Used", "Utilisés", "Использованные", "Kullanılmış", "Użyte", "Usados", "Usados", "Genutzt", "사용됨", "使用済み", "已使用"],
    ["No promo codes found", "Aucun code promo trouvé", "Промокоды не найдены", "Promosyon kodu bulunamadı", "Nie znaleziono kodów promocyjnych", "No se encontraron códigos promocionales", "Nenhum código promocional encontrado", "Keine Promo-Codes gefunden", "프로모션 코드를 찾을 수 없습니다", "プロモーションコードが見つかりません", "未找到兑换码"],
    ["Copied to clipboard", "Copié dans le presse-papiers", "Скопировано в буфер обмена", "Panoya kopyalandı", "Skopiowano do schowka", "Copiado al portapapeles", "Copiado para a área de transferência", "In die Zwischenablage kopiert", "클립보드에 복사됨", "クリップボードにコピーしました", "已复制到剪贴板"],
    ["Copy", "Copier", "Копировать", "Kopyala", "Kopiuj", "Copiar", "Copiar", "Kopieren", "복사", "コピー", "复制"]
  ];
